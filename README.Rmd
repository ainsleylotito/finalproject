...
We then created a FlexDashboard to display our analysis, which includes all code used to produce the visualizations from the cleaned datasets we produced in the prior step. This FlexDashboard is contained within the **[FILLINLATER]** file (located within the `/writing` folder).
